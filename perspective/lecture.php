...
<div id='text'>
<h4 class=title>Linear Perspective</h4>
...
function get_page($content) {
  ...
  $source = str_replace('@images', "./uged1533/images", $source);
...
get_page("history.html");
get_page("math.html");
get_page("circle.html");
get_page("curvilinear.html");
get_page("ref.html");
